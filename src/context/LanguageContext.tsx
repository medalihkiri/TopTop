...
export const translations: Translations = {
  ...
  searchPlaceholder: { ar: "ابحث عن عطر، مكون...", fr: "Rechercher un parfum, une note..." },
  noResults: { ar: "لا توجد نتائج مطابقة.", fr: "Aucun résultat trouvé." },
